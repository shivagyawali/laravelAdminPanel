...
@section('content')
    <main class="container mt-5 mx-auto  w-3/4 border-red">
                            ...
                            @foreach ($news as $item)
                                <tr>
                                    <td
                                        ...
                                        <img src="{{ asset($item->image) }}" class="object-center rounded " width="60px"
                                            alt="" srcset="">
                                    </td>
                                    <td
                                        class="border-t-0 px-6 align-middle border-l-0 border-r-0 text-xs whitespace-nowrap p-4">
                                    ...
                                    <td
                                        class="border-t-0 px-6 align-middle border-l-0 border-r-0 text-xs whitespace-nowrap p-4">
                                        {!! Str::limit($item->detail, 50) !!} <a href="{{ route('news.edit', $item->id) }}">
                                            ...Readmore</a>
                                    </td>
                                    <td
                                        class="border-t-0 px-6 align-middle border-l-0 border-r-0 text-xs whitespace-nowrap p-4">
                                        <span
                                            class="inline-flex items-center justify-center px-2 py-1 mr-2 text-xs font-bold leading-none text-red-100 {{ $item->is_published == 1 ? 'bg-green-600' : 'bg-red-600' }}  rounded-full">

                                            {{ $item->is_published == 1 ? 'Published' : 'Drafted' }}
                                        </span>
